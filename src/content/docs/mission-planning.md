...
Mission planning software allows pilots to program automated flights, which allow for precise, repeatable flights that are ideal for mapping. We recommend that you use a mission planning software when capturing data for use with WebODM. 

WebODM does not have an official mission planner (yet), but you can find a list of third party software below.
